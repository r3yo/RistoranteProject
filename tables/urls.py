...
urlpatterns = [
    ...
    path('table/<slug:pk>', TableDetailView.as_view(), name = "table-detail"),
    path('table/update/<slug:pk>', UpdateTableView.as_view(), name = "update-table"),
    path('table/delete/<slug:pk>', DeleteTableView.as_view(), name = "delete-table"),
